...
namespace We7.Framework.Util
{
    ...
    public class Utils
    {
        ...
        /// <param name="sb"></param>
        /// <param name="s"></param>
        public static void TrimEndStringBuilder(StringBuilder sb, string s)
        {
            if (sb.Length > 0)
                sb.Replace(s, "", sb.Length - s.Length, s.Length);
        }
        ...
        public static T CreateInstance<T>(string typename, string assemblyname)
        {
            ...
            return (T)ass.CreateInstance(typename);
        }
        ...
        {
            return (T)CreateInstance(fullname);
        }
        ...
        public static void BuidlPagerParam(int recordcount, int pagesize, ref int pageindex, out int startindex, out int itemscount)
        {
            if (pagesize <= 0)
                pagesize = 1;
        ...
        public static string FormartAttachmentUrl(object o)
        {
            string s = o as string;
            ResourceArray res = new ResourceArray();
            res = res.FromJson(s);
            if (res == null)
            {
                return String.Empty;
            }
            return res.Count > 0 ? (res[0] as string) : String.Empty;
        }
        ...
        /// <param name="o"></param>
        /// <returns></returns>
        public static string GetFirstImg(object o, string type)
        {
            return GetFirstImg(o, type, String.Empty);
        }
        ...
        public static string GetFirstImg(object o, string type, string defImg)
        {
            IIC iic = GetIIC(o);
            string firstImage = defImg;
            if (iic.Count > 0)
            {
                ImageItem fi = iic[0].GetItemByType(type);
                if (fi != null)
                {
                    firstImage = fi.Src;
                }
        ...
        /// <param IIC="iic"></param>
        /// <returns></returns>
        public static string FormartImgUrl(ImageInfo iio, string type)
        {
            return FormartImgUrl(iio, type, String.Empty);
        }
        ...
        /// <param IIC="iic"></param>
        /// <returns></returns>
        public static string FormartImgUrl(ImageInfo iio, string type, string defImg)
        {
            string result = defImg;
            ImageItem fi = iio.GetItemByType(type);
            if (fi != null && !string.IsNullOrEmpty(fi.Src.ToString().Trim()))
            {
                result = fi.Src;
            }
            return result;
