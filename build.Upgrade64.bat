...
DEL ..\Deploy\install-patch\bin\System.Data.SQLite.dll /Y
XCOPY "Solution Items\DLL\System.Data.SQLite_64.DLL" ..\Deploy\install-patch\bin\System.Data.SQLite.dll /E /Y
