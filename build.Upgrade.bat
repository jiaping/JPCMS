...
SET BUILDER="e:\Program Files\Microsoft Visual Studio 10.0\Common7\IDE\devenv.exe"

@ECHO Build projects...
%BUILDER% "We7 CMS.sln" /Build %CONFIG% > build.log.txt

@ECHO Building We7.CMS.Upgrade.32bit.zip...
...
DEL ..\We7.CMS.Upgrade.32bit.zip
%ZIP% a -tzip ..\We7.CMS.Upgrade.32bit.zip *
