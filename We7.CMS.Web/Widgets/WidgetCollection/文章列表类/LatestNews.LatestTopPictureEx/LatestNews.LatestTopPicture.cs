...
{
    [ControlGroupDescription(Label = "最新动态", Icon = "最新动态", Description = "最新动态", DefaultType = "LatestNews.LatestTopPicture")]
    [ControlDescription(Desc = "新闻动态+最新推荐+最新图文", Author = "老大")]
    public partial class LatestNews_LatestTopPictureEx : ThinkmentDataControl
    {
        private List<Article> latestNews, recommends, pictureNews;
        private Article headNews;
        ...
        /// 显示的文字新闻记录数
        /// </summary>
        [Parameter(Title = "文字信息记录条数", Type = "Number", DefaultValue = "6")]
        public int PageSize = 6;

        /// <summary>
        /// 轮显广告记录条数
        /// </summary>
        [Parameter(Title = "轮显广告记录条数", Type = "Number", DefaultValue = "5")]
        public int SliderSize = 5;

        /// <summary>
        /// 文字信息日期格式
        /// </summary>
        [Parameter(Title = "文字信息日期格式", Type = "String", DefaultValue = "[MM-dd]")]
        ...
        /// 自定义Css类名称
        /// </summary>
        [Parameter(Title = "自定义Css类名称", Type = "String", DefaultValue = "LatestNews_LatestTopPicture")]
        ...
        protected string FlashSlideData
        {
            get
            {
                ...
                {
                    sb.AppendFormat("{0}|", Pictures[i].GetTagThumbnail(ThumbnailTag));
