...
namespace We7.CMS.Web.Widgets
{
    ...
    public partial class NewsTab_Default : ThinkmentDataControl
    {
        ...
        /// 自定义Css类名称
        /// </summary>
        [Parameter(Title = "自定义Css类名称", Type = "String", DefaultValue = "NewsTab_Default")]
        ...
        protected string SetBoxBorderColor()
        {
            ...
            {
                return string.Format("border-color:{0};", BoxBorderColor);
            }
            return string.Empty;
        }      
            ...
            get
            {
                if (channellist == null)
                {
                    ...
                    for (int i = 0; i < ListOwnerID.Count; i++)
                    {
                        ...
                        List<Channel> templist = Assistant.List<Channel>(c, null, 0, 1,
                                                                         new string[]
                                                                             {
                                                                                 "ID", "Title", "FullUrl", "Created"
                                                                                 , "SN"
                                                                             });
        ...
        List<Article> QueryArticlesByChannel(Channel ch, bool includechildren, int from, int PageSize)
        {
            ...
            return Assistant.List<Article>(c, os, from, PageSize,new string[]
                                                                 {
