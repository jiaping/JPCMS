<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Header.SingleFlash.cs"
 Inherits="We7.CMS.Web.Widgets.Header_SingleFlash" %>
<script type="text/C#" runat="server">
    [ControlDescription("单个Flash页头")]
    string MetaData;
    ...
    <%--<div class="web_tool">
     ...
     <div id="logo">
        <object  classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" width="' + defaults.focus_width + '" height="' + defaults.swf_height + '">
            <param name="movie" value="/Widgets/WidgetCollection/网站页头/Header.SingleFlash/Images/Logo.swf" />
            ...
            <embed src="/Widgets/WidgetCollection/网站页头/Header.SingleFlash/Images/Logo.swf" wmode="transparent"   width="1000" height="180" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
            </object>
    </div>
</div>
</div>
