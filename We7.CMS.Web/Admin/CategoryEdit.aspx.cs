    ...
    public partial class CategoryEdit : BasePage
    {
        ...
        protected void SaveLinkbutton_Click(object sender, EventArgs args)
        {
            ...
            if (String.IsNullOrEmpty(id))
            {
                try
                {
					NameCheckLable.Visible = CategoryHelper.CheckNameRepeat(txtName.Text.Trim(),cat.ParentID, true);
            ...
            else
            {
                ...
                {
                    cat.ID = id;
					NameCheckLable.Visible = CategoryHelper.CheckNameRepeat(txtName.Text.Trim(), cat.ParentID, false);
