...
<div id="dialog" style="padding: 15px; display: none; background-color: #cad5eb;
    ...
    <div class="we7-dialog_warp">
        <label>
            名称：</label><input id="dialog_label" type="text"   />（* 尽量使用中文）</div>
    <div class="we7-dialog_warp">
        <label>
            标签：</label><input id="dialog_name" type="text"    />（* 仅允许数字与字母）</div>
    <div class="we7-dialog_warp">
    ...
    <div class="we7-dialog_warp" id="div_maxlength">
        <label>
            字段长度</label>
        <input type="text" id="dialog_maxlength" name="dialog_maxlength" />
    </div>
