...
<head>
	<title>选择一个<%=Request["type"] == "dep" ? "部门" : "类别"%></title>
	<base target="_self" />
	...
	<div style="display: table; min-height: 35px; width: 100%">
		<asp:GridView ID="DetailGridView" runat="server" AutoGenerateColumns="False" GridLines="Horizontal"
			...
			<Columns>
				...
				<asp:BoundField DataField="KeyWord" DataFormatString="{0}" HeaderText="关键字" />
				<asp:BoundField DataField="CreateDate" DataFormatString="{0}" HeaderText="创建时间" />
			</Columns>
		</asp:GridView>
	</div>
	<br />
