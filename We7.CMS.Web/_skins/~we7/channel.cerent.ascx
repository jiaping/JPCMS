...
<body style="background-color:rgb(255, 255, 255);background-image:url('');background-position:left top;background-repeat:repeat; background-attachment:scroll;">
 ...
 <wew:ArticleSingle_Default id="ArticleView_Default_131432928053765" dateformat="[MM-dd]" bordercolor="" titlelength="30" cssclass="ArticleSingle_Default" pagesize="3" filename="/Widgets/WidgetCollection/文章列表类/ArticleSingle.Default/ArticleSingle.Default.ascx" runat="server"></wew:ArticleSingle_Default></we7design:we7layoutcolumn>
</we7design:we7layout></we7design:we7layoutcolumn>
