...
<body style="background-color:rgb(255, 255, 255);background-image:url('');background-position:left top;background-repeat:repeat; background-attachment:scroll;">
 ...
 <wew:Foot_Text control="Foot_Text" filename="/Widgets/WidgetCollection/静态类/Foot.Text/Foot.Text.ascx" id="Foot_Text_146096472716074" cssclass="Foot_Text" runat="server"></wew:Foot_Text></we7design:we7layoutcolumn>
