...
<%@ Register Src="/Widgets/WidgetCollection/图文类/PagedPictureshizi/PagedPictureshizi.ascx" TagName="PagedPictureshizi" TagPrefix="wew" %>
...
<body style="background-color:rgb(255, 255, 255);background-image:url('');background-position:left top;background-repeat:repeat; background-attachment:scroll;">
 ...
 <wew:PagedPictureshizi id="PagedPictureshizi_131434975353663" thumbnailtag="szdw" isshow="False" includechildren="True" margintop10="True" icon="" bordercolor="" tags="" imageonly="True" dateformat="[MM-dd]" pager-requestpageindex="pi" pager-pagerdivclass="page_css page_line" cssclass="PagedPictureshizi" pager-pagesize="10" ownerid="{c019deae-5b4a-4a5f-95e5-1c8c36f93259}" titlelength="30" pager-pagerspanclass="pagecss" pager-vmtemplatefilename="/Widgets/WidgetCollection/文章列表类/PagedArticleList.Default/vm/pager.vm" filename="/Widgets/WidgetCollection/图文类/PagedPictureshizi/PagedPictureshizi.ascx" runat="server"></wew:PagedPictureshizi></we7design:we7layoutcolumn>
</we7design:we7layout></we7design:we7layoutcolumn>
