...
<body style="background-color:rgb(255, 255, 255);background-image:url('');background-position:left top;background-repeat:repeat; background-attachment:scroll;">
 ...
 <wew:PagedPictureArticleList_Default id="PagedPictureArticleList_Default_131433659148037" thumbnailtag="ldtp" isshow="False" includechildren="True" margintop10="True" icon="" bordercolor="" tags="" imageonly="True" dateformat="[MM-dd]" pager-requestpageindex="pi" pager-pagerdivclass="page_css page_line" cssclass="Lingdao_List" pager-pagesize="16" ownerid="{c77244ab-d046-493f-a7c5-90c63d424f91}" titlelength="20" pager-pagerspanclass="pagecss" pager-vmtemplatefilename="/Widgets/WidgetCollection/文章列表类/PagedArticleList.Default/vm/pager.vm" filename="/Widgets/WidgetCollection/图文类/PagedPictureArticleList.Default/PagedPictureArticleList.Default.ascx" runat="server"></wew:PagedPictureArticleList_Default></we7design:we7layoutcolumn>
</we7design:we7layout></we7design:we7layoutcolumn>
