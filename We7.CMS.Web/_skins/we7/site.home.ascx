...
<body style="background-color:rgb(255, 255, 255);background-image:url('');background-position:left top;background-repeat:repeat; background-attachment:scroll;">
 ...
 <wew:Header_LogoFlashWithTopItem id="Header_LogoFlashWithTopItem_146070987034536" iconrss="" searchpage="" iconlogin="" iconcollection="" cssclass="Header_LogoFlashWithTopItem" iconwap="" iconhomepage="" filename="/Widgets/WidgetCollection/网站页头/Header.LogoFlashWithTopItem/Header.LogoFlashWithTopItem.ascx" runat="server"></wew:Header_LogoFlashWithTopItem></we7design:we7layoutcolumn>
 ...
 <wew:ChannelMenu_TopMenu_OneGrade id="ChannelMenu_TopMenu_OneGrade_146070709310154" cssclass="ChannelMenu_TopMenu_OneGrade" filename="/Widgets/WidgetCollection/导航类/ChannelMenu.TopMenu.OneGrade/ChannelMenu.TopMenu.OneGrade.ascx" runat="server"></wew:ChannelMenu_TopMenu_OneGrade></we7design:we7layoutcolumn>
 ...
 <wew:ArticleList_Default id="ArticleList_Default_131426006002952" icon="" marginleft10="False" margintop10="False" bordercolor="" isshow="False" tags="" pagesize="8" ownerid="{05c31726-ba18-463b-843f-e3932b3f3c58}" cssclass="ArticleList_Default" includechildren="True" dateformat="[MM-dd]" titlelength="45" filename="/Widgets/WidgetCollection/文章列表类/ArticleList.Default/ArticleList.Default.ascx" runat="server"></wew:ArticleList_Default></we7design:we7layoutcolumn>
 ...
 <wew:ArticleList_2ColumnWidthImage id="ArticleList_2ColumnWidthImage_146029553386586" icon="" descriptionlength="30" thumbnailtag="flash" isshow="False" bordercolor="" picdesclength="20" tags="" pagesize="10" ownerid="{e936099e-a047-4195-8876-b07b4ad6c462}" cssclass="ArticleList_2ColumnWidthImage" titlelength="30" marginleft10="True" margintop10="True" includechildren="True" filename="/Widgets/WidgetCollection/文章列表类/ArticleList.2ColumnWidthImage/ArticleList.2ColumnWidthImage.ascx" runat="server"></wew:ArticleList_2ColumnWidthImage></we7design:we7layoutcolumn>
 ...
 <wew:ArticleList_Default id="ArticleList_Default_146051375558366" icon="" marginleft10="True" margintop10="True" bordercolor="" isshow="False" tags="" pagesize="10" ownerid="{05c31726-ba18-463b-843f-e3932b3f3c58}" cssclass="ArticleList_Default" includechildren="True" dateformat="[MM-dd]" titlelength="30" filename="/Widgets/WidgetCollection/文章列表类/ArticleList.Default/ArticleList.Default.ascx" runat="server"></wew:ArticleList_Default></we7design:we7layoutcolumn>
</we7design:we7layout></we7design:we7layoutcolumn>
 ...
 <wew:Footer_Default control="Footer_Default" filename="/Widgets/WidgetCollection/网站页脚/Footer.Default/Footer.Default.ascx" id="Footer_Default_146055077822562" cssclass="Footer_Default" runat="server"></wew:Footer_Default></we7design:we7layoutcolumn>
